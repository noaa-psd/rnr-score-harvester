...
TEST_DATA_FILE_NAMES = ['bfg_1994010100_fhr09_soil4_control.nc',
                        'bfg_1994010106_fhr06_soil4_control.nc',
                        'bfg_1994010106_fhr09_soil4_control.nc',
                        'bfg_1994010112_fhr06_soil4_control.nc',
                        'bfg_1994010112_fhr09_soil4_control.nc',
                        'bfg_1994010118_fhr06_soil4_control.nc',
                        'bfg_1994010118_fhr09_soil4_control.nc',
                        'bfg_1994010200_fhr06_soil4_control.nc']
...
def test_variable_names():
    ...
    assert data1[0].variable == 'soill4'

def test_global_stats_values():
    """ The harvester returns a numpy 32 bit floating point number.
        ...
        bfg_1994010100_fhr09_soil4_control.nc
        bfg_1994010106_fhr06_soil4_control.nc
        bfg_1994010106_fhr09_soil4_control.nc
        bfg_1994010112_fhr06_soil4_control.nc
        bfg_1994010112_fhr09_soil4_control.nc
    ...
    """
    data1 = harvest(VALID_CONFIG_DICT)
    global_mean = np.float32(0.7740828903167823)
    assert data1[0].value == global_mean
    global_std = np.float32(0.40290029918016645)
    assert data1[1].value == global_std

def test_units():
    data1 = harvest(VALID_CONFIG_DICT)
    assert data1[0].units == "xxx"
...
def test_longname():
    data1 = harvest(VALID_CONFIG_DICT)
    var_longname = "liquid soil mositure at layer-4"

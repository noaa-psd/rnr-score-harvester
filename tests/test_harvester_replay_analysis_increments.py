...
TEST_DATA_FILE_NAME = 'fv3_increment6_delp_lev03.nc'
...
FV3INC_PATH = os.path.join(TEST_DATA_PATH, TEST_DATA_FILE_NAME)

VALID_CONFIG_DICT = {'harvester_name': hv_registry.REPLAY_ANALYSIS_INCREMENTS,
                     'filename' : FV3INC_PATH,
                     'statistic': ['mean', 'variance', 'minimum', 'maximum'],
                     'variable': ['delp_inc']}

def test_variable_names():
    data1 = harvest(VALID_CONFIG_DICT)
    assert data1[0].variable == 'delp_inc'

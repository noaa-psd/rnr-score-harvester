...
HARVESTER_NAME   = 'global_bucket_evaporation_ave'
...
HarvestedData = namedtuple('HarvestedData', ['filenames',
                                             ...
                                             'units'])
@dataclass
class GlobalBucketEvaporationRateConfig(ConfigInterface):
...
@dataclass
class GlobalBucketEvaporationRateHv(object):
    ...
    """
    config: GlobalBucketEvaporationRateConfig = field(
                                default_factory=GlobalBucketEvaporationRateConfig)

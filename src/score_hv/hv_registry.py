...
from score_hv.harvesters.global_bucket_net_radiative_flux import GlobalBucketNetRadiativeFluxConfig, GlobalBucketNetRadiativeFluxHv
...
harvester_registry = {INNOV_NETCDF: Harvester(
                      ...
                      INC_LOGS: Harvester(
                          ...
                          LogIncCfg,
                          LogIncHv),
                      GLOBAL_BUCKET_NET_RADIATIVE_FLUX: Harvester(
